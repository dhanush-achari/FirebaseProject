...
public class InputEidActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        display.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(idv.isEmpty())
                {
                    Toast.makeText(InputEidActivity.this, "Please Enter EID", Toast.LENGTH_SHORT).show();
                }
                reffe.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        {
                            Toast.makeText(InputEidActivity.this, "Invaid EID", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Intent intent=new Intent(InputEidActivity.this,Retrive.class);
